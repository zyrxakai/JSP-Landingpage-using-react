  ...
  return (
    <Section id = "how-to-use">
        <div className='container'>
            ...
            text = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AI-Powered Job Matching: Utilizes AI to match job seekers with relevant opportunities based on &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;skills, experience, and career goals."
            />
            <div className='relative'>
                ...
                rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
                    ...
                    ml-auto'>
                        ...
                        Provides job suggestions based on specific skills rather than job titles.<br />
                        Offers recommendations for career progression and growth.
                        </p>
                        <ul className='body-2'>
                ...
                lg:grid-cols-2'>
                    ...
                    overflow-hidden'>
                        <div className='absolute inset-0'>
                            ...
                            width={630}
                            height={750}
                            src={resumegenerator} alt="robot"
                            />
                        </div>

                        <div className="absolute inset-0 flex
                        flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                            <h4 className='h4 mb-4'>Resume Generator</h4>
                        <p className='body-2 mb-[3rem] text-n-3'>
                        Enables job seekers to create and submit resumes to showcase their skills and personality.
                        </p>
                        </div>
                        {/* <PhotChatMessage /> */}
                    </div>
                    ...
                    overflow-hidden lg:min-h-[46rem]'>
                        <div className='py-12 px-4 xl:px-8'>
                            <h4 className='h4 mb-4'>Career Analytics and Insights</h4>
                            <p className='body-2 mb-[2rem] text-n-3'>Provides data-driven insights
                                 on job search performance, including profile views and application
                                  success rates.
                            </p>
